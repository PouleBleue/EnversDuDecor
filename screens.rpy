...
label start2: 
    call warning_initial
    call sequence_bug_tv

image rect_anime:
    # On agrandit le rectangle à 450 pixels de large
    # Tu peux changer 450 par 500 si c'est encore trop juste
    Transform("images/rect3.png", size=(560, 100))
...
screen navigation():
    vbox:
        ...
        # On n'affiche ces boutons QUE si on est dans un sous-menu (pas sur l'écran titre)
        if not main_menu:
...
style navigation_button:
    # L'image au repos (on peut mettre None pour que ce soit invisible)
    idle_background None 
    # Ton rectangle rouge quand on survol
    hover_background "images/rect.png" 
    
    # C'est ici que la magie opère pour la douceur :
    hover_sound None # Optionnel : ajoute un petit son de TV
    focus_mask True # Pour que le clic soit précis
...
screen main_menu():
    ...
    # 1. On affiche d'abord le plateau télé (le fond)
    add "images/pt1.png" 

    # 2. On affiche ton dessin de télé par-dessus (centré)
    add "images/image_6e9e98.png" align (0.5, 0.5)

    # 3. On affiche la zone des boutons et du titre
    fixed:
        anchor (0.5, 0.5)
        pos (0.5, 0.5)
        xoffset -145  
        ...
        # Titre du jeu
        label _("L\'Envers du Décor"):
            xalign 0.3
            ypos -30 
            text_size 45
            text_color "#ff0000"
            text_font "font/CourierPrime-Regular.ttf" 
        ...
        vbox:
            ...
            button:
                ...
                xsize 450 ysize 70
                add "rect_anime"
                text _("Nouvelle partie"):
                    align (0.5, 0.5)
                    font "font/CourierPrime-Regular.ttf"
                    idle_color "#c0c0c0"
                    hover_color "#ffffff"
